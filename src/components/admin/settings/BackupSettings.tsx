      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div>
            ...
            <Input id="backup-retention" type="number" defaultValue="30" className="max-w-sm" />
        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <Input id="s3-bucket" defaultValue="adjja-backups" />
            </div>
            <div>
              <Label htmlFor="s3-region">S3 Region</Label>
              <Input id="s3-region" defaultValue="ap-southeast-2" />
            </div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-bjj-gray">Restore database from backup</p>
            </div>
            <Switch />
          </div>
          <div className="flex items-center justify-between">
            <div>
              <h4 className="font-medium">Restore Files</h4>
              <p className="text-sm text-bjj-gray">Restore uploaded files from backup</p>
            </div>
            <Switch />
          </div>
